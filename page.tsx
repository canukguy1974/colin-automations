          ...
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
            <Card className="border-neutral-800 bg-neutral-900/50">
              ...
              <CardContent className="space-y-4">
                ...
                <Button asChild className="bg-emerald-500 text-black hover:bg-emerald-400">
                  <a href="CALENDLY_LINK" target="_blank" rel="noreferrer">Open calendar</a>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-neutral-800 bg-neutral-900/50">
              ...
              <CardContent className="space-y-4">
                ...
                <Button asChild variant="outline" className="border-neutral-700 bg-neutral-900 hover:bg-neutral-800">
                  <a href="mailto:CONTACT_EMAIL?subject=Setup%20my%20automation&body=Here%20are%20the%20tools%20I%20use:%20Stripe/PayPal/Drive/Gmail/Slack%20...">Write an email</a>
                </Button>
              </CardContent>
            </Card>
          </div>
